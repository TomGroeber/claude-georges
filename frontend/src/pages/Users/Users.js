...
function Users() {
  ...
  const pages = [{ name: t('users'), href: '/users', current: true }];
  ...
  const handlePagination = (pageNumber, pageSize, searchKey, query, sortBy, sortOrder) => {
    setLoader(true);
    Api.getAllUsers(pageNumber, pageSize, searchKey, query, sortBy, sortOrder).then((response) => {
  ...
  return (
    <div className="relative">
      <Helmet>
        <meta charSet="utf-8" />
        <title>Users | Vacation Manager Admin</title>
      </Helmet>
          ...
          <div className="mt-3 sm:mt-0 flex justify-between">
            ...
            <div className="flex">
              <div className="ml-3 self-center">
                <button
                  type="button"
                  onClick={() => navigate("/users/add-edit")}
              ...
              <div className="ml-3 self-center inline-flex items-center justify-center">
                {/* <button
                  className="inline-flex items-center justify-center rounded-3xl border border-transparent bg-gradient-to-r from-vacation-primary to-vacation-secondary px-5 py-2 text-sm font-medium text-white shadow-sm hover:vacation-primary focus:outline-none sm:w-auto"
